...
public class Login extends javax.swing.JFrame {
    ...
    private void EnterButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EnterButtonActionPerformed
        try {
            ...
            } else if (AccountNumber.getText().contains("123456789") && Pin.getText().contains("1111")) {
                Menu Main = new Menu();
                String Account = AccountNumber.getText();
                Main.AccountNumberLabel.setText(Account);
                Main.setVisible(true);
                dispose();
                
                
            } else if(AccountNumber.getText().contains("987654321") && Pin.getText().contains("2222")){
                Menu Main = new Menu();
                String Account = AccountNumber.getText();
                Main.AccountNumberLabel.setText(Account);
                Main.setVisible(true);
