...
public class MenuAdmin extends javax.swing.JFrame {
    ...
    public void Function(){
        ...
        try {
            ...
            pst = Connection.prepareStatement("select * from accounttable");
    ...
    private void AddNewButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddNewButtonActionPerformed
        ...
        if(name.equals("")||username.equals("")||password.equals("")||ContactNumber.equals("")||Address.equals("")){
            ...
            try{
                ...
                pst = Connection.prepareStatement("insert into accounttable(Name,Username,Password,ContactNumber,Address)value(?,?,?,?,?)");
    ...
    private void DeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteActionPerformed
        ...
        try {
            ...
            if (deleteItem == JOptionPane.YES_OPTION) {
                Connection();
                pst = Connection.prepareStatement("DELETE FROM accounttable WHERE id = ?");
                pst.setInt(1, id);
                pst.executeUpdate();
